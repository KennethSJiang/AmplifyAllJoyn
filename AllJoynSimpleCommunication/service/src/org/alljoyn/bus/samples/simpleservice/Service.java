...
public class Service extends Activity {
    ...
    private static final int TOTAL_SAMPLE_POINTS = 10000;
    ...
    private void analyze(String message){
    	...
    	counter++;
    	if(counter == 1){
    		startTime = Long.parseLong(message);
    	}
    	else if(counter == TOTAL_SAMPLE_POINTS){
    		long totalTime = endTime-startTime;
    		long avgTime = totalTime/TOTAL_SAMPLE_POINTS;

    		String status = "Total Sample Points [" + counter + "]. Avg Time Spent [" + avgTime + 
    				"] ms. Total Time Spent " + totalTime + "] ms";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        startTime = 0;
        counter = 0;
        Toast.makeText(this, "Reset the start time to " + startTime, Toast.LENGTH_LONG).show();
